# 𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦: https://t.me/+nRhAsOdRjU8xMTNl
...
def banner():
    ...
    print(f"{C}  {W}{BOLD} ███████║██║  ██║╚██████╔╝██║     ██║██║        ██║   {RESET}")
    print(f"{C}  {W}{BOLD} ╚══════╝╚═╝  ╚═╝ ╚═════╝ ╚═╝     ╚═╝╚═╝        ╚═╝   {RESET}")
    print(f"            {C}Created by @DEADLINEHERE5 | @DEADLINE CLOUD VIP{RESET}")
    print()
...
async def print_result(session, cc_string, message, price, currency, category, charged_by=None, override_clean=None):
    ...
    print(f"{C}━━━━━━━━━━━━━{RESET}")
    print(f"{W}力 {C}𝐃𝐞𝐯 -» {W}@deadlinehere5{RESET}")
...
async def checker_mass():
    ...
    print(f"{C}━━━━━━━━━━━━━━{RESET}")
    print(f"{W}𝐃𝐞𝐯: @deadlinehere5{RESET}")
